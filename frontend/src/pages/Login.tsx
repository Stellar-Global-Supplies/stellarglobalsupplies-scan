...
const styles: Record<string, React.CSSProperties> = {
  ...
  form:  { display:'flex', flexDirection:'column', gap:10, marginBottom:'1rem' },
  input: { padding:'10px 12px', border:'1px solid #ddd', borderRadius:8, fontSize:14, outline:'none', boxSizing:'border-box' as const },
  error: { color:'#d32f2f', fontSize:13, margin:0, textAlign:'left' },
  ...
  divider: { display:'flex', alignItems:'center', gap:12, margin:'1rem 0' },
  dividerText: { fontSize:12, color:'#aaa', background:'#fff', padding:'0 8px' },
